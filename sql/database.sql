...
CREATE TABLE `layout_options` (
  ...
  `list_backup_id` varchar(31) NULL default NULL,
...
INSERT INTO list_options ( list_id, option_id, title, seq, is_default, option_value, notes ) VALUES ('language', 'bokmål_norwegian_norwegian_bok', 'Bokmål, Norwegian; Norwegian BokmÃ¥l', 220, 0, 0, 'nob');
