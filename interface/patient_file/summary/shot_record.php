...
$sqlstmt = "select date_format(i1.administered_date,'%Y-%m-%d') as '" . xl('Date') . "\n" . xl('Administered') . "' ".
			...
			",concat(i1.amount_administered,' ',i1.amount_administered_unit) as '" . xl('Amount') . "\n" . xl('Administered') . "' ".
			...
			",i1.route as '" . xl('Route') . "'".
            ",i1.administration_site as '" . xl('Administration') . "\n" . xl('Site') . "'".
			",i1.note as '" . xl('Comments') . "'".			
			//",IF(i1.added_erroneously = 1, 'Immunization information was entered into the wrong patient’s record', '')  as '" . xl('') . "'".
